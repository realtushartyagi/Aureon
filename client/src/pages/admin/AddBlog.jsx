    ...
    <form 
      ...
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          {loading && ( <div className='absolute top-[50%] left-[50%] -transform-translate-x-[50%] -transform-translate-y-[50%] '>
        ...
        <p className='mt-4'>Blog Category</p>
          ...
          <div className='flex gap-2 mt-4'>
            <p>Publish Now</p>
            <input type="checkbox" checked={isPublished} className='scalw-125 cursor-pointer' onChange={e => setIsPublished(e.target.checked)} />
          </div>
